        ...
        <div class="col-md-12 col-12">
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        <form class="form form-vertical" method="POST" action="{{route('store-dashboard-product')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="stock" class="form-control"
                                                    name="stock" placeholder="Masukan Stok">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <img id="image-preview" src="" alt="Preview Gambar" style="max-width: 100%; display: none;">
                                        </div>
                                    </div>
